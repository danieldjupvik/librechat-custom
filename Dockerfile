...
RUN sed -i '/const titleInstruction =/s/'\''[^'\'']*'\''/'\''&. Start the title with one emoji that fits the topic (REQUIRED), The emoji should help communicate the subject.'\''/g' /app/api/app/clients/OpenAIClient.js
